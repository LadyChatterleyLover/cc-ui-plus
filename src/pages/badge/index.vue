<template>
  <view>
    ...
    <view>
      ...
      <view class="demo">
        <view class="demo-item">
          <cc-badge :content="8" bg-color="#1989fa">
            <view class="child" />
          </cc-badge>
        </view>
        <view class="demo-item">
          <cc-badge :content="50" :max="20" bg-color="red" color="green">
            <view class="child" />
          </cc-badge>
        </view>
      </view>
    ...
    <view>
      ...
      <view class="demo">
        ...
        <view class="demo-item">
          <cc-badge :content="50" dot bg-color="#1989fa">
            <view class="child" />
          </cc-badge>
        </view>
      </view>
      ...
      <view class="demo">
        <view class="demo-item">
          <cc-badge>
            <view class="child" />
            <template #content>
              <cc-icon type="person" color="#fff" size="12" />
            </template>
          </cc-badge>
        </view>
        <view class="demo-item">
          <cc-badge bg-color="#1989fa">
            <view class="child" />
            <template #content>
              <cc-icon type="search" color="#fff" size="12" />
            </template>
          </cc-badge>
        </view>
      </view>
    ...
    <view>
      ...
      <view class="demo">
        ...
        <view class="demo-item">
          <cc-badge bg-color="#1989fa" content="50" :offset="[-20, -20]">
            <view class="child" />
          </cc-badge>
        </view>
      </view>
