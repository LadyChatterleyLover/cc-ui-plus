<template>
  <view>
    ...
    <view class="title">
      <cc-collapse :list="list1" />
    </view>

    <view class="title">右侧箭头显示和样式</view>
    <view class="item">
      <cc-collapse :list="list2" />
    </view>

    <view class="title">默认展开项</view>
    <view class="item">
      <cc-collapse :current="current1" :list="list1" />
    </view>

    <view class="title">手风琴模式</view>
    <view class="item">
      <cc-collapse accordion :list="list1" />
    </view>

    <view class="title">禁用和无边框</view>
    <view class="item">
      <cc-collapse :list="list3" />
    </view>

    <view class="title">自定义内容</view>
    <view class="item">
      <cc-collapse :list="list4">
        <template #title1> <cc-icon type="search" />搜索 </template>
        <template #content1>
        ...
        <template #title2> <cc-icon type="person" />晴天 </template>
        <template #content2>
...
const list1 = [
  {
    title: '晴天',
    content:
      '故事的小黄花，从出生那年就飘着童年的荡秋千，随记忆一直晃到现在故事的小黄花，从出生那年就飘着童年的荡秋千，随记忆一直晃到现在',
  },
  {
    title: '晴天',
    content:
      '吹着前奏望着天空，我想起花瓣试着掉落为你翘课的那一天，花落的那一天教室的那一间，我怎么看不见消失的下雨天，我好想再淋一遍',
  },
  {
    title: '晴天',
    content:
...
const list2 = [
  ...
  },
  {
    title: '你听得到',
    content:
      '没想到失去的勇气我还留着，好想再问一遍你会等待还是离开，刮风这天我试过握着你手但偏偏雨渐渐，大到我看你不见还要多久我才能在你身边，等到放晴的那天我会比较好一点',
    arrowSize: 30,
  },
]
const list3 = [
