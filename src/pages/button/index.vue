<template>
  <view class="container">
    ...
    <view>
      ...
      <view class="item">
        <view class="item-content">
          <cc-button icon="link">2046</cc-button>
        </view>
        <view class="item-content">
          <cc-button type="primary" icon="chat" />
        </view>
        <view class="item-content">
          <cc-button type="success" plain icon="weibo" />
        </view>
      </view>
    </view>
    ...
    <view>
      ...
      <view>
        <cc-button style="margin: 20px 0" type="primary" block icon="chat"
          >块级按钮</cc-button
        >
      </view>
      <view>
    ...
    <view>
      ...
      <view class="item">
        ...
        <view class="item-content">
          <cc-button type="primary" loading icon="chat" />
        </view>
        <view class="item-content">
    ...
    <view>
      ...
      <view class="item">
        ...
        <view class="item-content">
          <cc-button color="linear-gradient(to right, #ff6034, #ee0a24)"
            >维多利亚一号</cc-button
          >
        </view>
      </view>
